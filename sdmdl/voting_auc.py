...
path_dir='F:/github/bird/result/rsep/청개구리/MLP'
...
for j in range(0,5,1):
    ...
    for count in range(0, 1, 1):
        ...
        try:
            ...
            true_data=pd.read_csv("%s/%s/Hyla_japonica_total_env_dataframe_test.csv" % (path_dir, folder[j]), engine='python')['present/pseudo_absent']
